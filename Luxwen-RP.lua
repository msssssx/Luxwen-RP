...
if enable_autoupdate then
	...
	if updater_loaded then
		...
		if autoupdate_loaded then
			Update.json_url = "https://raw.githubusercontent.com/msssssx/Luxwen-RP/main/version.json?" .. tostring(os.clock())
			Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
			Update.url = "https://github.com/msssssx/Luxwen-RP/"
		end
	end
end
