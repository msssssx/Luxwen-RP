...
function sampev.onServerMessage(color, text)
	...
	elseif text:find("^%[A%]") or text:find("^{AFAFAF}%[A%]") and not text:find("%[A%] Игрок: .+ и получил мут!$") then
		...
		if color == -1347440726 or color == -1347440641 or color == -1007741441 or color == -1263159297 or text:find("%[%d+ HP%]$") or text:find("освободил игрока .+ из тюрьмы$") then
			color = 0xFFFFFFFF
